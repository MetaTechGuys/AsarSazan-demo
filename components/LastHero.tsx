      ...
      <motion.div className="cus-hv-center sticky inset-0 bottom-auto h-screen overflow-clip">
        <motion.div style={{ scale }} className="size-full">
          <Image
            src={MEDIA.lastHero}
            alt=""
            className="-z-1 size-full object-cover dark:brightness-50"
          />
        </motion.div>
        <div className="cus-hv-center absolute inset-0">
          <motion.div
            style={{ opacity, y }}
            className="flex flex-col gap-4 text-center text-white text-shadow-md dark:brightness-75"
          >
            <h1 className="text-3xl font-extrabold sm:text-5xl md:text-7xl lg:text-9xl">
              {title}
            </h1>
            <p className="text-tussock-50 sm:text-xl md:text-2xl lg:text-3xl">
              {text}
            </p>
          </motion.div>
        </div>
        ...
        >
          <g className="fill-background">
            <motion.g style={{ x: 960, y: p1y }}>
              <path d="M0,286.25 C0,286.25 -124,541.5 -124,541.5 C-124,541.5 120,541.5 120,541.5 C120,541.5 0,286.25 0,286.25z" />
            </motion.g>
            <motion.g style={{ x: 960, y: p2y }}>
              <path d="M1768,-932 C1768,-932 -1756,-932 -1756,-932 C-1756,-932 -1756,540 -1756,540 C-1756,540 -524.8837890625,845.294189453125 -524.8837890625,845.294189453125 C-524.8837890625,845.294189453125 -0.025999298319220543,-252.60781860351562 -0.025999298319220543,-252.60781860351562 C-0.025999298319220543,-252.60781860351562 528.0709228515625,845.8578491210938 528.0709228515625,845.8578491210938 C528.0709228515625,845.8578491210938 1768,548 1768,548 C1768,548 1768,-932 1768,-932z" />
            </motion.g>
          </g>
        </motion.svg>
      </motion.div>
